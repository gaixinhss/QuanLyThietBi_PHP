    ...
    <div class="container-lg bg-light">
        <div class="d-flex align-items-start fw-semibold fs-5">
            <div class="nav flex-column nav-pills  py-3 col-sm-3 bg-dark-subtle" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <button class="nav-link   py-4" id="v-borrow-equipment-tab" data-bs-toggle="pill" data-bs-target="#v-borrow-equipment-tab" type="button" role="tab" aria-controls="v-borrow-equipment-tab" aria-selected="false"><i class="fa-brands fa-product-hunt"></i> Mượn thiết bị</button>
                <button class="nav-link   py-4" id="v-borrow-equipment-a-tab" data-bs-toggle="pill" data-bs-target="#v-pills-equipment" type="button" role="tab" aria-controls="v-pills-equipment" aria-selected="false"><i class="fa-brands fa-product-hunt"></i> Yêu cầu sữa chữa</button>
            </div>
            <div class="tab-content col-md-9 ps-4" id="v-pills-tabContent">
                ...
                <!-- pane mượn thiết bị -->
                <div class="tab-pane fade   " id="v-borrow-equipment-tab" role="tabpanel" aria-labelledby="v-pills-equipment-tab" tabindex="0">
                    <nav>
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>
                                                <a href='#' class='delete-button'>
                                                    <button style=''><a href='#'>Mượn</a></button>
                                                </a>
                                            </td>
                                        </tr>";
                                }
